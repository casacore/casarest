...
int main (Int argc, char** argv)
{
  try {
    ...
    Vector<Int> spwid(makeVector(inputs.getIntArray("spwid")));
    Int npix         = inputs.getInt("npix");
    Int nfacet       = inputs.getInt("nfacets");
    Vector<Int> nchan(makeVector(inputs.getIntArray("nchan")));
    Vector<Int> chanstart(makeVector(inputs.getIntArray("chanstart")));
    Vector<Int> chanstep(makeVector(inputs.getIntArray("chanstep")));
    ...
    Vector<Double> userScaleSizes(makeVector(inputs.getDoubleArray("uservector")));
