//# PBWProjectFT.h: Definition for PBWProjectFT
...
//#
//#
//# $Id: PBWProjectFT.h,v 1.12 2006/12/22 05:29:33 gvandiep Exp $
...
namespace casa { //# NAMESPACE CASA - BEGIN
  ...
  // WProjectFT, PBWProjectFT does Grid-based Fourier transforms but
  ...
  // data. PBWProjectFT allows efficient handling of direction
  ...
  public:
    ...
    // <group>
    PBWProjectFT(MeasurementSet& ms, EPJones *epjPtr,
		 //		 VPSkyJones* vpSJ,
    ...
    /*
      PBWProjectFT(MeasurementSet& ms, EPJones *epjPtr, 
      Int nFacets, Int cachesize, Bool applyPointingOffset=True,
      Int tilesize=16, 
      Float paSteps=5.0, Float pbLimit=5e-2,
      Bool usezero=True);
    */
    ...
    void put(const VisBuffer&,
	     ...
	     UVWMachine*, Bool) 
    {
      //    throw(AipsError("PBWProjectFT::put is not implemented"));
    }
