...
MultiTermFT::~MultiTermFT()
{
 ...
 if(dbg_p) cerr << "MTFT :: destructor for term " << thisterm_p << " - assumes automatic deletion of subftm " << endl;
...
{
  if(dbg_p) cerr << "MTFT :: getImage for term " << thisterm_p << endl;
...
{
  if(dbg_p) cerr << "MTFT :: getWeightImage for term " << thisterm_p << endl;
...
{
  if(dbg_p) cerr << "MTFT :: makeImage for term " << thisterm_p << endl;
...
{
   if(dbg_p) cerr << "MTFT :: toRecord for term " << thisterm_p << endl;
 Bool retval = True;
...
{
  if(dbg_p) cerr << "MTFT :: fromRecord for term " << thisterm_p << endl;
  Bool retval = True;
