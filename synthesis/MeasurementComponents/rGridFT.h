//# rGridFT.h: Definition for rGridFT
...
//
// <etymology>
// FTMachine is a Machine for Fourier Transforms. rGridFT does
// Grid-based Fourier transforms.
// </etymology>
//
// <synopsis> 
// The <linkto class=SkyEquation>SkyEquation</linkto> needs to be able
// to perform Fourier transforms on visibility data. rGridFT
...
// (e.g. UVW coordinates).
//
// Gridding and degridding in rGridFT are performed using a
...
public:
  ...
  virtual void normalizeImage(Lattice<Complex>& skyImage,
			      ...
			      Bool fftNorm)
    {throw(AipsError("rGridFT::normalizeImage() called"));}
