...
#include <casarest/synthesis/MeasurementEquations/IncEntropy.h>
...
class IncCEMemModel: public LinearModel< Lattice<Float> > 
{
...
public:
  ...
  IncCEMemModel(IncEntropy &ent, 
		Lattice<Float> & model,      // previous model, logically const
		Lattice<Float> & deltaModel, // this one changes 
...
protected:
  ...
  Float itsFlux;       // this is the total Flux
  Float itsModelFlux;  // this is the flux of image itsModel_ptr
  Float itsDeltaFlux;  // this is the flux of image itsDeltaModel_ptr
  Float itsChisq;
