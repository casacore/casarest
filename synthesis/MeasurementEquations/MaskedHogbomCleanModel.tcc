//# MaskedHogbomCleanModel.cc:  this defines MaskedHogbomCleanModel
...
#include <casarest/synthesis/MeasurementEquations/MaskedHogbomCleanModel.h>
...
solve(ConvolutionEquation & eqn){
  ...
  while ((n < numberIterations()) && (abs(maxVal) > threshold())){
    ...
    if (eqn.evaluate(psf, maxPos, 1.0f, residual.shape())){
      ...
      theModel.getRWArray()(maxPos) += amplitude; 
