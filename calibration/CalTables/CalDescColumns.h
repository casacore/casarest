...
class ROCalDescColumns 
{
 ...
 protected:
  ...
  void attach (const CalTable& calTable, TableMeasColumn& tabCol, 
	       MSCalEnums::colDef colEnum, const Bool& optional = False);
  void attach (const CalTable& calTable, ArrayQuantColumn<Double>& tabCol, 
	       MSCalEnums::colDef colEnum, const Bool& optional = False);
...
class CalDescColumns 
{
 ...
 protected:
  ...
  void attach (CalTable& calTable, TableColumn& tabCol, 
	       MSCalEnums::colDef colEnum, const Bool& optional = False);
  void attach (CalTable& calTable, TableMeasColumn& tabCol, 
	       MSCalEnums::colDef colEnum, const Bool& optional = False);
  void attach (CalTable& calTable, ArrayQuantColumn<Double>& tabCol, 
	       MSCalEnums::colDef colEnum, const Bool& optional = False);
